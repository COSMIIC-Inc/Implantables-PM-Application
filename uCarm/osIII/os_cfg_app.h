...
#define  OS_CFG_TASK_STK_LIMIT_PCT_EMPTY  10u               /* Stack limit position in percentage to empty            */
                                                            ...
                                                            /* ---------------------- IDLE TASK --------------------- */
#define  OS_CFG_IDLE_TASK_STK_SIZE        64u    //JML changed from 128             /* Stack size (number of CPU_STK elements)                */
...
#define  OS_CFG_INT_Q_TASK_STK_SIZE      128u               /* Stack size (number of CPU_STK elements)                */
                                                            ...
                                                            /* ------------------- STATISTIC TASK ------------------- */
#define  OS_CFG_STAT_TASK_PRIO             8u               /* Priority                                               */
#define  OS_CFG_STAT_TASK_RATE_HZ          1u               /* Rate of execution (1 to 10 Hz)                         */
#define  OS_CFG_STAT_TASK_STK_SIZE        64u    //JML changed from 128             /* Stack size (number of CPU_STK elements)                */


                                                            /* ------------------------ TICKS ----------------------- */
#define  OS_CFG_TICK_RATE_HZ            1000u               /* Tick rate in Hertz (10 to 1000 Hz)                     */
#define  OS_CFG_TICK_TASK_PRIO             6u               /* Priority                                               */
#define  OS_CFG_TICK_TASK_STK_SIZE        64u   //JML changed from 128      /* Stack size (number of CPU_STK elements)                */
