...
#define  CLK_CFG_ARG_CHK_EN                     DEF_DISABLED
...
#define  CLK_CFG_SIGNAL_FREQ_HZ                         1u   /* Configure signal frequency  (see Note #3).   1 sec called from RTC clock  */
